...
struct StoryBrain {
    ...
    func getTitleText() -> String {
        return stories[titleNumber].title
    }

    func getChoice1() -> String {
        return stories[titleNumber].choice1
    }

    func getChoice2() -> String {
        return stories[titleNumber].choice2
    }

    mutating func nextTitle(userChoice: String) {
        let currentStory = stories[titleNumber]

        if userChoice == currentStory.choice1 {
            titleNumber = currentStory.choice1Destination
        } else if userChoice == currentStory.choice2 {
            titleNumber = currentStory.choice2Destination
        }
    }
}
